namespace _02.VaniPlanning
{
    ...
    public class Invoice
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return other.SerialNumber.Equals(this.SerialNumber) &&
                   other.CompanyName.Equals(this.CompanyName) &&
                   other.Subtotal.Equals(this.Subtotal) &&
                   other.Department.Equals(this.Department) &&
                   other.IssueDate.Equals(this.IssueDate) &&
                   other.DueDate.Equals(this.DueDate);
        }
