namespace _01.Red_Black_Tree.Tests
{
    ...
    public class RedBlackThreeTests
    {
        ...
        public void TestDeleteMultiple()
        {
            ...
            this.RedBlackTree.Delete("M");
            this.RedBlackTree.Delete("S");
            this.RedBlackTree.Delete("R");
            this.RedBlackTree.Delete("X");
        ...
        {
            IEnumerable<string> expected = new List<string>(){"M", "E", "L", "H", "R", "P", };
            IEnumerable<string> actual = this.RedBlackTree.Range("E", "R");
